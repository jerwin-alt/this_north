...
import {
  Loader, AlertCircle, Calendar, Clock, Edit2, X, Check,
        ...
        <div className="flex flex-wrap justify-between items-start gap-4 mb-8 fade-in">
          <div>
            ...
            <p style={{ color: MUTED_GRAY, fontSize: '0.82rem', letterSpacing: '0.03em', marginLeft: 48 }}>
              View customer orders and manage pickup schedules
            </p>
          </div>
        </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem' }}>
              <thead>
                <tr style={{
                  ...
                  {['Order #', 'Customer', 'Date', 'Pickup', 'Total', 'Status', 'Payment', 'Schedule'].map(col => (
                    <th key={col} style={{
                    ...
                    >
                      ...
                      <td style={{ padding: '13px 20px' }}>
                        <span style={{
                          ...
                          padding: '3px 10px', borderRadius: 999,
                          fontSize: '0.68rem', fontWeight: 600,
                          background: order.payment_status === 'paid' ? 'rgba(52,196,104,0.1)' :
                            order.payment_status === 'partially_paid' ? 'rgba(234,179,8,0.1)' :
                            'rgba(239,68,68,0.08)',
                          color: order.payment_status === 'paid' ? '#1a7a3c' :
                            order.payment_status === 'partially_paid' ? '#92670a' :
                            '#c0392b',
                          border: `1px solid ${order.payment_status === 'paid' ? 'rgba(52,196,104,0.2)' :
                            order.payment_status === 'partially_paid' ? 'rgba(234,179,8,0.2)' :
                            'rgba(239,68,68,0.15)'}`,
                          textTransform: 'capitalize',
                        }}>
